...
export const metadata: Metadata = {
  title: "Akira Hotel Tokyo - Luxury Japanese Hospitality",
  description: "Experience luxury hospitality blending Japanese tradition with modern design. Premium rooms, Michelin-starred dining, and authentic onsen spa in the heart of Tokyo.",
  keywords: "luxury hotel Tokyo, Japanese hospitality, premium rooms, spa, fine dining",
  metadataBase: new URL("https://akirahotel.tokyo"),
  alternates: {
    canonical: "https://akirahotel.tokyo"
  },
  openGraph: {
    title: "Akira Hotel Tokyo",
    description: "Luxury Japanese Hotel in Tokyo - Tradition Meets Contemporary Design",
    url: "https://akirahotel.tokyo",
    siteName: "Akira Hotel",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764623458847-7yjgvwiw.jpg",
        alt: "Akira Hotel Tokyo"
      }
    ]
  },
  twitter: {
    ...
    title: "Akira Hotel Tokyo",
    description: "Premium luxury hotel experience in Tokyo",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764623458847-7yjgvwiw.jpg"]
  }
};
